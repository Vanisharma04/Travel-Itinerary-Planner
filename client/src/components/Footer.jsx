  ...
  return (
    <footer className="shadow-lg bg-[#ffffff] sm:p-6 ">
            ...
            <div className="grid grid-cols-3 gap-6 sm:gap-4 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul className="text-gray-600 ">
                        <li className="mb-1">
                            <div className="hover:underline"><i className="ri-links-line"></i><span className="text-bold">Address :</span>Jais Amethi </div>
                        </li>
                        <li className="mb-1">
                            <div className="hover:underline"><i className="ri-mail-line"></i><span className="text-bold">Email :</span>roserise@gmail.com</div>
                        </li>
                        <li className="mb-1">
                            <div className="hover:underline"><i className="ri-phone-line"></i><span className="text-bold">Phone :</span>+91 7544368956</div>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm ml-16 text-gray-800 text-center ">© 2024 <a href="https://flowbite.com/" className="hover:underline">ROSE RISE™</a>. All Rights Reserved.
            </span>
